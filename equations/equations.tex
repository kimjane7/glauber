...
&\frac{\partial^2 \chi}{\partial \sigma^2} (f,\sigma) = \sum_i \left[ \left( \frac{\partial \varepsilon_i}{\partial \sigma} (f,\sigma) \right)^2 - (\alpha_i-\varepsilon_i(f,\sigma)) \left( \frac{\partial^2 \varepsilon_i}{\partial \sigma^2} (f,\sigma) \right)\right] \\
